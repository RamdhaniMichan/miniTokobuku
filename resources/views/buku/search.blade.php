...
@if(count($databuku))
<div class="container">
	<div class="alert alert-info">Ditemukan {{count($databuku)}} data dengan kata {{$cari}}</div>
	...
	@else
	<div class="alert alert-info"><h3 class="m-0 font-weight-bold text-primary">Data {{$cari}} tidak ditemukan</h3>
		<a href="/buku"><button class="btn btn-primary">Kembali</button></div></a>
	</div>
	</div>
	@endif
</div>
